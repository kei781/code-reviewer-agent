...
export const implementationPhases = [
  {
    ...
    goal: 'Run a webhook-driven local review-server flow where Claude Code orchestrates independent Claude Code and Codex reviews and publishes only codebase-validated findings.',
    entryCriteria: [
      'Root ADR.md and PRD.md v4 have been reviewed.',
